...
describe IsTaggable::ListToolbox::Youtube do
  ...
  describe "#extract(str)" do
    context "str is several words separated by spaces" do
      it("should return list of words") { subject.extract('one two').should == ['one', 'two'] }
    end

    context "str is several quoted multiword sequences separated by spaces" do
    ...
    context "str is several words and quoted multiword sequences separated by spaces" do
      it("should return list quoted sequences and words (FEATURE: words go before quoted sequences)") { subject.extract('"is_taggable has" some "quoted tags"').should == ['some', '"is_taggable has"', '"quoted tags"'] }
    end

    context "str is several sequences separated by spaces" do
    ...
    context "str is several sequences separated by spaces and sequences include quotation marks" do
