...
I'd like to improve the gem by making it more modern (rails 3, rspec, etc), flexible and maintainable.

There are a lot of internal changes, but my goal is to keep default behaviour compatible with 
